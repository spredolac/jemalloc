...
CTL_PROTO(opt_hpa_purge_delay_ms)
...
static const ctl_named_node_t opt_node[] = {{NAME("abort"), CTL(opt_abort)},
    ...
    {NAME("hpa_purge_delay_ms"),
        CTL(opt_hpa_purge_delay_ms)},
...
CTL_RO_NL_GEN(opt_hpa_purge_delay_ms,
    opt_hpa_opts.purge_delay_ms, uint64_t)
